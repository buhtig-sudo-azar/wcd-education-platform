    ...
    <div className="space-y-2">
      ...
      {isExpanded && (
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <Button size="sm" className="h-7 text-xs gap-1" onClick={handleSave} disabled={!inputValue.trim()}>
              <Key className="h-3 w-3" /> Сохранить
            </Button>
            <Button variant="ghost" size="sm" className="h-7 text-xs" onClick={() => { setIsExpanded(false); setInputValue(''); }}>
              Отмена
            </Button>
          </div>
