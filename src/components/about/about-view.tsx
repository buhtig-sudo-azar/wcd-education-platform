  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">О проекте</h1>
          <p className="text-sm text-muted-foreground">WCD Education Platform</p>
        </div>
      </div>
      ...
      <Card className="mb-6 border-border">
        <CardContent className="p-6">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            лаборатории и получать помощь от AI-ассистента.
          </p>
          <div className="flex flex-wrap gap-2">
            ...
            <Badge variant="secondary" className="text-xs">OpenRouter AI</Badge>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6 border-border">
        <CardContent className="p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold text-foreground">Что вы изучите</h2>
          </div>
      ...
      <Card className="mb-6 border-border">
        <CardContent className="p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold text-foreground">Полезные ресурсы</h2>
          </div>
          <div className="space-y-3">
            {[
              ...
              <a
                ...
                className="flex items-center gap-3 p-3 rounded-lg border border-border hover:border-emerald-500/30 hover:bg-emerald-500/5 transition-colors group"
              >
                <ExternalLink className="h-4 w-4 text-muted-foreground group-hover:text-emerald-400 shrink-0" />
                <div className="min-w-0">
                  <p className="text-sm font-medium text-foreground group-hover:text-emerald-400 transition-colors">{resource.title}</p>
      ...
      <Card className="mb-6 border-border">
        <CardContent className="p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold text-foreground">Технологический стек</h2>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {[
              ...
              { name: 'OpenRouter', desc: 'AI API провайдер' },
            ].map((tech) => (
      ...
      <Card className="border-emerald-500/20 bg-gradient-to-br from-emerald-500/5 to-cyan-500/5">
        <CardContent className="p-6">
          <div className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-cyan-500 text-white font-bold text-lg">
              A
            </div>
            <div>
              <p className="text-lg font-bold text-foreground">создатель AZAR</p>
              <p className="text-sm text-muted-foreground">Интерактивная образовательная платформа по Web Cache Deception</p>
            </div>
          </div>
        </CardContent>
      </Card>
